...
program main
  ...
  integer, parameter :: NUM_GPU_RUNS = 2, SCALE_I = 4, SCALE_J = 4
  ...
  write(canonical_name, '(a)') 'GPU: DO CONCURRENT; no OpenMP'
  print *, 'Running ', (canonical_name)
  call serial_driver_doc(irank, NUM_GPU_RUNS, sclr, inarr, outarr, test_time_arr_)
